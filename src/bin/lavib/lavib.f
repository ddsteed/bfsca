...
C *-/
      ...
      parameter(chanmax=220,itermax=10,nrgmax=100,enermax=120,
     $     lammax=21,setmax=1,boundmax=6,vibmax=20,pwavemax=11,nlmomax
     $     =16,exlmmax=60)
...
CARR
      ...
      parameter(chanmax=220,enermax=120,symmax=4,vibmax=20,nrgmax=100
     $     ,potptsmax=330)
...
C * This is the routine that reads in the Unit 5 crap
     ...
     $     ,wexe)
      ...
      parameter(chanmax=220,itermax=10,nrgmax=100,lammax=21,symmax=4
     $     ,enermax=120,setmax=1,boundmax=6,vibmax=20)
...
C * a neat table. (HAHAHAHAHAHAHAHAHAHHAHAHA)
      ...
      parameter(enermax=120, vibmax=20)
      double precision cross(enermax, vibmax)
      double precision energy(enermax)
...
CARR
      ...
      parameter(chanmax=220,enermax=120,vibmax=20)
      double precision tmati(chanmax,chanmax),tmatr(chanmax,chanmax)
...
CARR
      ...
      parameter (chanmax=220,ptsmax=331,itermax=10)
...
CARR
      ...
      parameter (chanmax=220,ptsmax=331)
...
C * when calculating the exchange potential
     ...
     $     ,nlproj,mlproj,l0proj,nbound,nexdim)
      ...
      parameter(chanmax=220,exlmmax=60,boundmax=6,nlmomax=16)
      double precision clebx1(boundmax,chanmax,exlmmax,nlmomax)
      double precision clebx2(boundmax,chanmax,exlmmax,nlmomax)
      double precision clebx3(boundmax,chanmax,exlmmax,nlmomax)
      double precision clebx4(boundmax,chanmax,exlmmax,nlmomax)
...
CARR
      ...
      parameter(potptsmax=330,lammax=21,vibmax=20,cntrmax=2,nrgmax=100)
...
CARR
      ...
      parameter(chanmax=220,pwavemax=11,lammax=21)
...
C *         alpha0, alpha2 and q now properly use this size
     ...
     $     ,fmat,nlamdain,nlams,chin,vibdim,nch,npw)
      ...
      parameter(chanmax=220,pwavemax=11,vibmax=20,lammax=21)
      double precision fmat(pwavemax,pwavemax,lammax)
      double precision alpha0(vibmax,vibmax),alpha2(vibmax,vibmax)
      double precision q(vibmax,vibmax) 
...
CARR
      ...
      parameter(chanmax=220,potptsmax=330,ptsmax=331,pwavemax=11,lammax
     $     =21,vibmax=20)
...
CARR
      ...
      parameter(lammax=21,vibmax=20,potptsmax=330)
